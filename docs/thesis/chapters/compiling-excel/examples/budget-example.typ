...
While actually compiling this spreadsheet might be overkill, it provides a good way to think about the computations and help visualise the ideas presented in this thesis. We will introduce the various components of the budget example along the way. 
