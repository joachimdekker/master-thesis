...
The result of this thesis is ideally a tool that can convert (part of) the excel tool used by the pension funds. @subsec:insufficient-data describes some of the difficulties to come to this part.
